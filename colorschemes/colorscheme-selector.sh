...
# This script is from:
# https://github.com/linkarzu/dotfiles-latest/blob/main/colorscheme/colorscheme-selector.sh

# Path to the directory containing color scheme scripts
COLORSCHEME_DIR="$HOME/.config/colorschemes/list"

# Path to the colorscheme-set.sh script
COLORSCHEME_SET_SCRIPT="$HOME/.config/colorschemes/colorscheme-set.sh"
